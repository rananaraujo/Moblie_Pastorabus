    ...
    protected void onResume() {
        ...
        final LocationCallback locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                CircleOptions c107 = new CircleOptions();
                c107.center( new LatLng(-4.978512, -39.054797));
                c107.radius(GEOFENCE_RADIUS);
                c107.strokeColor(Color.argb(255, 255, 0, 0));
                c107.fillColor(Color.argb(64,255, 0, 0));

                CircleOptions c108 = new CircleOptions();
                c108.center( new LatLng(-4.978394, -39.052383));
                c108.radius(GEOFENCE_RADIUS);
                c108.strokeColor(Color.argb(255, 255, 0, 0));
                c108.fillColor(Color.argb(64,255, 0, 0));

                CircleOptions c109 = new CircleOptions();
                c109.center( new LatLng(-4.978223, -39.050806));
                c109.radius(GEOFENCE_RADIUS);
                c109.strokeColor(Color.argb(255, 255, 0, 0));
                c109.fillColor(Color.argb(64,255, 0, 0));

                CircleOptions c110 = new CircleOptions();
                c110.center( new LatLng(-4.973917, -39.033086));
                c110.radius(GEOFENCE_RADIUS);
                c110.strokeColor(Color.argb(255, 255, 0, 0));
                c110.fillColor(Color.argb(64,255, 0, 0));

                CircleOptions c111 = new CircleOptions();
                c111.center( new LatLng(-4.972581, -39.024129));
                c111.radius(GEOFENCE_RADIUS);
                c111.strokeColor(Color.argb(255, 255, 0, 0));
                c111.fillColor(Color.argb(64,255, 0, 0));

                CircleOptions c112 = new CircleOptions();
                c112.center( new LatLng(-4.972592, -39.023678));
                c112.radius(GEOFENCE_RADIUS);
                c112.strokeColor(Color.argb(255, 255, 0, 0));
                c112.fillColor(Color.argb(64,255, 0, 0));

                CircleOptions c113 = new CircleOptions();
                c113.center( new LatLng(-4.972549, -39.022584));
                c113.radius(GEOFENCE_RADIUS);
                c113.strokeColor(Color.argb(255, 255, 0, 0));
                c106.fillColor(Color.argb(64,255, 0, 0));
